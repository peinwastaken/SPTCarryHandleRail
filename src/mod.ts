...
// custom
import { PeinAssetReplace } from "./PeinAssetReplace";
...
implements IPreSptLoadMod, IPostDBLoadMod
{
    ...
    private peinAssetReplace : PeinAssetReplace = new PeinAssetReplace();
    ...
    // Initialize the instance manager DO NOTHING ELSE BEFORE THIS
        ...
        this.peinAssetReplace.preSptLoad(this.Instance)
    }
    ...
    // Initialize the instance manager DO NOTHING ELSE BEFORE THIS
        ...
        this.peinAssetReplace.postDBLoad();
    }
